...
$(document).ready(function () {
  ...
  $(".readmore-btn").on("click", function () {
    ...
    if ($(this).parent().parent().hasClass("showContent")) {
      $(this).text("Less ");
      $(this)
        .append(`<svg width="1.5em" height="1.5em" viewBox="0 4 18 10"  class="bi bi-arrow-up-circle" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      ...
      $(this).text("More ");
      $(this)
        .append(`<svg width="1.5em" height="1.5em" viewBox="0 4 18 10" class="bi bi-arrow-down-circle" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
